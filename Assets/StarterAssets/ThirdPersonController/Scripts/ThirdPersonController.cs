...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        {
            // Handle punch input
            if (_input.punch && _hasAnimator)
            {
                _animator.SetTrigger(_animIDPunch);
                _input.punch = false; // Reset punch input after triggering
            }

            // Handle kick input
            if (_input.kick && _hasAnimator)
            {
                _animator.SetTrigger(_animIDKick);
                _input.kick = false; // Reset kick input after triggering
            }
        }
